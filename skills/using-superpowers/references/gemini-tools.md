...
Skills dispatch with `Subagent (general-purpose):` and either reference a prompt-template file (a `*-prompt.md` file beside the skill) or supply an inline prompt. On Gemini CLI:
