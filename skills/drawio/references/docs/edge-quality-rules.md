...
8. **T-junction branching for flowcharts (`|->` style)**
   - For sequential vertical flowcharts with exclusions or details, branch the edge orthogonally from the midpoint of the vertical connection arrow using waypoints, rather than from the block itself.
