...
- branch exclusions, side-processes, or auxiliary paths orthogonally from the midpoint of vertical flow connectors (`|->` style) using waypoints rather than directly from the step blocks, ensuring a clear and prominent linear primary pathway.
