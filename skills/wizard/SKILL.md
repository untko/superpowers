---
name: wizard
description: Use when a human must do steps the agent cannot, such as provisioning infrastructure, setting credentials or CI secrets, or a one-off cutover. Generates an interactive bash wizard that walks them through each step.
---
